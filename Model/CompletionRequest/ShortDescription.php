...
class ShortDescription extends AbstractCompletion implements CompletionRequestInterface
{
    ...
    public function getApiPayload(array $text): array
    {
        ...
        $promptTxt = $text['custom_prompt'] === "true" ?
            $text['prompt'] :
            sprintf(
                'Write a short description for "%s" product.
                Please do the html formatting of the content and add Features bullet point. Use <ul><li></li></ul>
                format. First write product name with unique title then write some line of description and
                then Add Features in <h2> tag. In the last add some description.
